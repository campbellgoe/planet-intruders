...
import PhysicsScene from "@/components/scenes/PhysicsScene2";
      ...
      >
        {isActiveCurrentCannonDebuggerState && (
          <CannonDebugger color={cannonDebuggerColor}>
            <PhysicsScene cameraPosition={cameraPosition}/>
          </CannonDebugger>
        )}
        {!isActiveCurrentCannonDebuggerState && <PhysicsScene cameraPosition={cameraPosition}/>}
      </Physics>
