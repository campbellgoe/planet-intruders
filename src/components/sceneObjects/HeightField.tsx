...
export function generateHeightmap({
  ...
  const seedPoints = [];
  for (let i = 0; i < amountOfSeedPoints; i++) {
...
const HeightmapGeometry = ({
  ...
  useEffect(() => {
    ...
    // }, [heights]);
  }, [heights, elementSize]); //todo check applicability
...
const Heightfield = ({
  ...
  const [ref] = useHeightfield(() => heightFieldOptions, useRef<Mesh>(null));
